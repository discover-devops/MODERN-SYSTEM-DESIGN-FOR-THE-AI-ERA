...
## COURSE DESCRIPTION (paste into Graphy)

```
Most system design courses prepare you for 
FAANG interviews.

This one prepares you for the real world.

If you are a mid-level Cloud or DevOps engineer 
targeting a senior role — system design is the 
round that separates you from every other candidate.

In 8 live sessions across 4 weekends, you will 
learn to design real systems the way senior 
engineers actually think about them.

Not slides. Not theory. Live whiteboarding on 
Draw.io with real AWS and Azure scenarios — 
taught by an Ex-AWS engineer who has designed 
real production systems for 20 years and 
interviewed hundreds of engineers.

What makes this different from every other 
system design course:

✓ CI/CD system design — nobody else teaches this
✓ Observability platform design from scratch
✓ GenAI + EKS + AWS Bedrock — final session
✓ Maximum 15 students — real interaction
✓ Live Draw.io every session — see the thinking, 
  not just the answer
✓ Real AWS/Azure service mapping every session
✓ Taught by an Ex-AWS hiring manager who knows 
  what separates a senior answer from a 
  mid-level answer

By the end of 8 sessions you will be able to 
walk into any system design interview for a 
Senior Cloud Engineer, Senior DevOps Engineer, 
SRE, Platform Engineer, or Cloud Architect 
role — and think clearly under pressure.
